          ...
          <tr>
            <td align="center" valign="top"><table width="770" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="bottom">
				...
				<input name="1dataida" type="text" class="form" id="1dataida" size="13" maxlength="15"></td>
              ...
              <tr>
                <td align="left"><span class="textoform">
                  <input name="2dataida" type="text" class="form" id="2dataida" size="13" maxlength="15">
                  </span></td>
                <td align="left"><span class="textoform">
                  <input name="2datavolta" type="text" class="form" id="2datavolta" size="13" maxlength="15">
                  </span></td>
              ...
              <tr>
                <td align="left" valign="top"><span class="textoform">
                  <input name="3dataida" type="text" class="form" id="3dataida" size="13" maxlength="15">
                  </span></td>
                <td align="left" valign="top"><span class="textoform">
                  <input name="3datavolta" type="text" class="form" id="3datavolta" size="13" maxlength="15">
                  </span></td>
              ...
              <tr>
                <td align="left" valign="top"><span class="textoform">
                  <input name="4dataida" type="text" class="form" id="4dataida" size="13" maxlength="15">
                  </span></td>
                <td align="left" valign="top"><span class="textoform">
                  <input name="4datavolta" type="text" class="form" id="4datavolta" size="13" maxlength="15">
                  </span></td>
                <td colspan="2" align="left" valign="top">&nbsp;</td>
              </tr>
              <tr>
